  ...
  if (subscriptionStatus === 'pro') {
    return (
      <motion.div
        ...
        animate={{ opacity: 1, scale: 1 }}
        transition={{ delay: 0.8, type: "spring", stiffness: 200 }}
        className="mt-3 relative overflow-hidden bg-gradient-to-br from-purple-50/90 via-pink-50/90 to-rose-50/90 dark:from-purple-900/30 dark:via-pink-900/30 dark:to-rose-900/30 backdrop-blur-xl rounded-2xl px-3 py-2 border border-purple-200/50 dark:border-purple-800/50 shadow-xl hover:shadow-2xl transition-all duration-500"
      >
        {/* Background decorative elements */}
        <div className="absolute inset-0 bg-gradient-to-br from-purple-100/30 to-pink-100/30 dark:from-purple-900/15 dark:to-pink-900/15 rounded-2xl"></div>
        <div className="absolute top-1 right-1 w-3 h-3 rounded-full bg-gradient-to-br from-purple-400/60 to-pink-400/60 animate-pulse"></div>
        <div className="absolute bottom-1 left-1 w-2 h-2 rounded-full bg-gradient-to-br from-pink-400/40 to-purple-400/40 animate-pulse delay-500"></div>
