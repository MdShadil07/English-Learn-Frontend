    ...
    const button = (
      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            <motion.div
              ...
              whileHover={{ rotate: isActive ? 0 : [0, -5, 5, 0] }}
          ...
          {isActive && (
            <motion.div
              className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-8 bg-gradient-to-b from-white/80 to-emerald-200/60 rounded-r-full"
              initial={{ scaleY: 0 }}
              animate={{ scaleY: 1 }}
              transition={{ duration: 0.3 }}
            />
        ...
        {!collapsed && item.isNew && (
          <motion.div
            className="absolute -top-1 -right-1 w-3 h-3 bg-gradient-to-r from-orange-400 to-red-500 rounded-full shadow-lg"
